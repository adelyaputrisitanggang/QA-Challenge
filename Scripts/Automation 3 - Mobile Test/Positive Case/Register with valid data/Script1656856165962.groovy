...
Mobile.setText(findTestObject('Object Repository/Mobile Test/android.widget.EditText (1)'), 'felber91182terrill@randomail.io', 
    0)
...
Mobile.verifyElementExist(findTestObject('Mobile Test/android.widget.TextView - Registration Successful'), 0)
